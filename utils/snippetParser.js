...
function parseSnippet(snippetPath, name, text) {
  ...
  if (!("title" in properties))
    return raise(`Missing 'title' property`, snippetPath);
  if (!("description" in properties))
    return raise(`Missing 'description' property`, snippetPath);
  if (!("author" in properties))
    return raise(`Missing 'author' property`, snippetPath);
  if (!("tags" in properties))
    return raise(`Missing 'tags' property`, snippetPath);
